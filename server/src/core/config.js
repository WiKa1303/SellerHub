...
export const config = {
  ...
  // ═══ KI-Proxy (Modul 2, KONZEPT-KI-Proxy.md) ═══
  // Leerer Key = Proxy antwortet 503 (bewusster Degradations-Pfad: das Bildstudio
  // fällt still auf eigenen Browser-Key bzw. Pollinations zurück).
  geminiApiKey: process.env.GEMINI_API_KEY || '',
  // Kostenbremsen: Tageslimits je Nutzer, Text/Bild getrennt (Bild ist deutlich teurer)
